...
## Reinforcement learning (CPU Q-table)

Train / monitor at `/rl`. Algorithm notes: [`backend/RL/qlearn.md`](backend/RL/qlearn.md).

Human-demo **action heuristics** (on by default for CPU warm-up):
