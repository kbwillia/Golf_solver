...
GLOSSARY = {
    ...
    "action_heuristics": "Human-demo gates for CPU Q. Soft discard prior biases take_discard Q₀ (good/pair +, junk −). Hard discard gate bans taking discard ≥ junk pts unless it pairs. Pair force-take: if discard matches a known rank, only take is legal. Ban junk on private: on last round / last slot, forbid placing 10/Q/K onto a known low private card. Hard gates apply after bootstrap only so EV/human teachers stay free.",
